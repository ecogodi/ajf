...
module.exports = (config) => {
  ...
  config.set({
    ...
    files: [
      ...
      {pattern: 'node_modules/chart.js/dist/Chart.js', included: false, watched: false},
      {pattern: 'node_modules/chart.piecelabel.js/build/Chart.PieceLabel.min.js', included: false, watched: false},
      {pattern: 'node_modules/css-element-queries/**/*.js', included: false, watched: false},
